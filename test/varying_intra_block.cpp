...
TEST_CASE("unlimited concurrency:"){
    ...
    tbb::flow::function_node<DataBlock<V>,DataBlock <V>> init_adder(g,tbb::flow::serial,InitAdder<V>{xi1,xi2});
    ...
    tbb::flow::make_edge(sequencer3,init_adder);

    tbb::flow::make_edge(init_adder,zic);
